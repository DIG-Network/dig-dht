...
### Bug Fixes
- **record:** Bound CandidateAddr::host size at the shared address-normalization helper (#25)

## [0.14.0] - 2026-08-27

### Features
- **record:** Carry an optional untrusted mirror-coin pointer on the provider record (#24)

## [0.13.0] - 2026-08-25

### Build
- **deps:** Adopt dig-nat 0.21 (live-circuit relay fix), release 0.13.0 (#22)
...
### Features
- **service:** Cache lookup-learned providers so a later dial skips rediscovery (#20)
